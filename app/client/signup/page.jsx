            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input id="firstName" name="firstName" type="text" autoComplete="given-name" placeholder="e.g. Tameem"
                ...
                <div>
                  ...
                  <input id="lastName" name="lastName" type="text" autoComplete="family-name" placeholder="e.g. Hussein"
                    className="block w-full rounded-xl border border-slate-300 bg-slate-50/60 px-4 py-2.5 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-slate-700">How will you use Networkk?</label>
                <p className="text-xs text-slate-400">
                  Choose whether you&apos;re hiring on behalf of a company or as an individual.
                </p>
                <div className="flex flex-col sm:flex-row gap-3 mt-1">
                  <label className="flex items-center gap-2 text-sm text-slate-700">
                    <input type="radio" name="accountTypeRadio" value="company"
                      checked={accountType === "company"} onChange={() => setAccountType("company")}
                      className="h-4 w-4 text-[#079c02] border-slate-300 focus:ring-[#079c02]" />
                    <span>Company</span>
                  </label>
                  <label className="flex items-center gap-2 text-sm text-slate-700">
                    <input type="radio" name="accountTypeRadio" value="personal"
                      checked={accountType === "personal"} onChange={() => setAccountType("personal")}
                      className="h-4 w-4 text-[#079c02] border-slate-300 focus:ring-[#079c02]" />
                    <span>Personal</span>
                  </label>
                </div>
                  ...
                  <div className="mt-3 space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input id="companyName" name="companyName" type="text" placeholder="e.g. Networkk Inc."
                      ...
                      <div>
                        <label htmlFor="companyField" className="block text-xs font-medium text-slate-700 mb-1">Field / industry</label>
                        <input id="companyField" name="companyField" type="text" placeholder="e.g. Construction, Software, Design"
                          className="block w-full rounded-xl border border-slate-300 bg-slate-50/60 px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500" />
                      </div>
                    </div>
                    <div>
                      <label htmlFor="companyLocation" className="block text-xs font-medium text-slate-700 mb-1">Location</label>
                      <input id="companyLocation" name="companyLocation" type="text" placeholder="e.g. Cairo, Egypt"
                        className="block w-full rounded-xl border border-slate-300 bg-slate-50/60 px-3 py-2 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500" />
                    </div>
                  </div>
                )}
              ...
              {/* Phone (Egypt) */}
              <div>
                <label htmlFor="phone" className="block text-sm font-medium text-slate-700 mb-1.5">Phone number (Egypt)</label>
                <input id="phone" name="phone" type="tel" autoComplete="tel"
                  ...
                  className="block w-full rounded-xl border border-slate-300 bg-slate-50/60 px-4 py-2.5 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-500" />
                <p className="mt-1 text-xs text-slate-400">Must be an Egyptian mobile starting with 010, 011, 012, or 015.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="passwordConfirm" className="block text-sm font-medium text-slate-700 mb-1.5">Re-write your password</label>
              ...
              {/* hidden field to send accountType */}
